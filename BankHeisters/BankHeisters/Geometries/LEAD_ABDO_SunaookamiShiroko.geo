...
<AssetObjects..GeometryInstance>
	...
	<m_DataFiles>
		<Element>
			<m_ID text="GR2"/>
			<m_RelativePath text="LEAD_ABDO_SunaookamiShiroko.fgx"/>
		</Element>
		<Element>
			<m_ID text="WIG"/>
			<m_RelativePath text="LEAD_ABDO_SunaookamiShiroko.wig"/>
		</Element>
	</m_DataFiles>
	<m_Name text="LEAD_ABDO_SunaookamiShiroko"/>
	<m_Description text="LEAD_ABDO_SunaookamiShiroko"/>
	<m_Tags>
		<Element text="Leader"/>
	</m_Tags>
</AssetObjects..GeometryInstance>
